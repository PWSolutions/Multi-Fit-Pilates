    ...
    <div>
      ...
      <div class="hide-on-med-and-up">
        <ul id="dropdown1" class="dropdown-content large">
          ...
          <li><a className={TopMenuStyles.navItem} activeClassName={TopMenuStyles.activeNavItem} href="/floormat">Floor Mat</a></li>
          <li><Link className={TopMenuStyles.navItem} activeClassName={TopMenuStyles.activeNavItem} to="/reformer">Reformer</Link></li>
